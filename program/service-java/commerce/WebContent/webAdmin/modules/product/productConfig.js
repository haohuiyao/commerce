...
var ProductApi = (function() {
    ...
    var PRODUCT_APIS  =
    {
        ...
        MOD_BRAND_CLASSIFY : BASE_URL + "machineBrand/editCategoryBrand.action",//编辑品牌分类
        GET_CLASSIFY_LIST : BASE_URL + "category/getAllCategories.do",//获取产品分类
        GET_CLASSIFY_CHILD_LIST : BASE_URL + "category/getAllChildCategory.do",//获取产品parentId下的所有分类
        ...
        GET_CLASSIFY_BY_BRAND : BASE_URL + "machineBrand/getCategoryByBrand.do",//根据品牌获取分类
